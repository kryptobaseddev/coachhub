...
- [Why CoachHub?](#why-coachhub)
- [Core Features](#core-features)
- [Getting Started](#getting-started)
- [App Layout and Screenshots](#app-layout-and-screenshots)
  - [User Interface](#user-interface)
    - [Navbar](#navbar)
    - [Dashboard](#dashboard)
    - [Interior Controls](#interior-controls)
    - [Exterior Controls](#exterior-controls)
...
![Dashboard](/assets/appScreenshots/coachhub-dashboard.png)

#### Interior Controls

Manage interior lighting, appliances, and other amenities.

![Interior Controls](/assets/appScreenshots/coachhub-interior.png)

#### Exterior Controls

Control exterior lights and check exterior system statuses.

![Exterior Controls](/assets/appScreenshots/coachhub-exterior.png)

#### Climate Control

Manage your Climate settings all in one convenient place, thermostats, vents and heated floors!

![Climate Control](/assets/appScreenshots/coachhub-climatecontrol.png)
...
![Notifications](/assets/appScreenshots/coachhub-notifications.png)

#### Status Panel

Monitor real-time data on battery levels, tank capacities, and other vital statistics.

![Status Panel](/assets/appScreenshots/coachhub-systemstatus.png)
...
- **General**
  ...
  ![System Config - General](/assets/appScreenshots/coachhub-admin-dashboard.png)

- **Network**

  ![System Config - Network](/assets/appScreenshots/coachhub-admin-coachconfig-systemconfig-network.png)

- **Backup & Restore**

  ![System Config - Backup & Restore](/assets/appScreenshots/coachhub-admin-coachconfig-systemconfig-backuprestore.png)

- **Security**

  ![System Config - Security](/assets/appScreenshots/coachhub-admin-coachconfig-systemconfig-security.png)
...
- **Coach Info**
  ...
  ![Coach Config - Coach Info](/assets/appScreenshots/coachhub-admin-coachconfig-coachinfo.png)

- **Zones**

  ![Coach Config - Zones](/assets/appScreenshots/coachhub-admin-coachconfig-zones.png)

- **Device Groups**

  ![Coach Config - Device Groups](/assets/appScreenshots/coachhub-admin-coachconfig-devicegroups.png)

#### Automations

Create and manage automation rules to streamline your motorhome operations.

![Automations](/assets/appScreenshots/coachhub-admin-coachconfig-automations.png)

#### User Management

Manage user accounts and set access levels for different users.

![User Management](/assets/appScreenshots/coachhub-admin-coachconfig-usermanagement.png)
...
- **Website:** [www.mycoachhub.app/support](https://www.mycoachhub.app/support)
